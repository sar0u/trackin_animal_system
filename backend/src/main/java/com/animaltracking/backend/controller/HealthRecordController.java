...
public class HealthRecordController {
    ...
    public List<HealthRecord> getByAnimal(@PathVariable Integer animalId) {
    ...
    public ResponseEntity<HealthRecord> update(@PathVariable Integer id, @RequestBody HealthRecord record) {
