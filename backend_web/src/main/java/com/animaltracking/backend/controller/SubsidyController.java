...
import com.animaltracking.backend.repository.SubsidyRepository;
...
public class SubsidyController {
    ...
    private final com.animaltracking.backend.service.SubsidyService subsidyService;
    ...
    public ResponseEntity<Map<String, Object>> updateStatus(@PathVariable Long id, @RequestBody Map<String, String> payload) {
        ...
        if (newStatus != null) {
            subsidy.setStatus(com.animaltracking.backend.entity.SubsidyStatus.valueOf(newStatus));
