...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    severity    ENUM('INFO','LOW','MEDIUM','WARNING','HIGH','CRITICAL') DEFAULT 'INFO',
    created_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_alerts_farm   FOREIGN KEY (farm_id)   REFERENCES farms(id)   ON DELETE CASCADE,
    CONSTRAINT fk_alerts_animal FOREIGN KEY (animal_id) REFERENCES animals(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
