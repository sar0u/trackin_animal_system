...
class _VeterinaireHomeScreenState extends State<VeterinaireHomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<VeterinaireProvider>(context, listen: false).loadFarms();
    });
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (provider.isLoadingFarms)
          ...
          else if (provider.farms.isEmpty)
            OutlinedButton.icon(
            ...
            DropdownButtonFormField<int>(
              ...
              onChanged: (value) {
                ...
                final farm = provider.farms.firstWhere((f) => f.id == value);
                setState(() {
