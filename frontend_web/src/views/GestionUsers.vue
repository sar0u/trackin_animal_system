...
.btn-add { background-color: #0B5D1E; color: white; border: none; padding: 10px 20px; border-radius: 8px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: 0.2s; }
.btn-add:hover { background-color: #063B16; }
...
.role-agent { background: #fef3c7; color: #d97706; }
...
.page-controls button.active { background: #0B5D1E; color: white; border-color: #0B5D1E; }
...
.form-group input:focus, .form-group select:focus { border-color: #0B5D1E; }
...
.btn-confirm { padding: 10px 15px; background: #0B5D1E; border: none; border-radius: 8px; font-weight: 600; color: white; cursor: pointer; }
.btn-confirm:hover:not(:disabled) { background: #063B16; }
.btn-confirm:disabled { opacity: 0.7; cursor: not-allowed; }
.btn-deactivate-account { padding: 10px 15px; background: #fff7ed; border: 1px solid #fed7aa; color: #ea580c; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; gap: 8px; }
.btn-deactivate-account:hover { background: #fed7aa; border-color: #fb923c; }
.btn-activate-account { padding: 10px 15px; background: #f0fdf4; border: 1px solid #bbf7d0; color: #063B16; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.2s; display: inline-flex; align-items: center; gap: 8px; }
.btn-activate-account:hover { background: #bbf7d0; border-color: #4ade80; }
.phone-col { color: #4b5563; font-size: 13px; }
.status-active { background: #d1fae5; color: #047857; }
.status-inactive { background: #f1f5f9; color: #6b7280; }
.form-static-value { padding: 10px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px; color: #374151; font-weight: 500; }
.input-error { border-color: #ef4444 !important; background: #fff5f5; }
.input-error:focus { border-color: #ef4444 !important; box-shadow: 0 0 0 3px rgba(239,68,68,0.1); }
.field-error { display: block; margin-top: 4px; font-size: 12px; color: #ef4444; font-weight: 500; }
.field-hint { display: block; margin-top: 3px; font-size: 11px; color: #9ca3af; }
</style>